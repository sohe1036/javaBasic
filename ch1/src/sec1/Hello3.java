...
public class Hello3 {
	...
	public static void main(String[] args) {
		...
		age = sc.nextInt();				//키보드에 입력한 내용을 정수로 age에 저장
		System.out.println("키(신장) 입력 : ");
		height = sc.nextDouble();		//키보드에 입력한 내용을 실수로 height에 저장
		//전체 저장한 정보를 출력
		System.out.println("너의 이름은 "+name+"이고, 나이는 "+age+" 세이며, 키는"+height+" 센티미터입니다.");
